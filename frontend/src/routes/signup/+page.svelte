            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="#">
                    <div>
                        ...
                        class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " placeholder="" required={true}>
                    </div>
                    <div>
                        <label for="name" class="block mb-2 text-sm font-medium text-gray-900 ">Name</label>
                        <input type="name" name="name" id="name" placeholder="" bind:value={name}
                    ...
                    <div>   
                        <label for="password" class="block mb-2 text-sm font-medium text-gray-900">Comfirm password</label>
                        <input type="password" name="re_password" id="re_password" bind:value={re_password}
                        class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required={true}>
                    </div>
                    ...
                    {/if}
                    <button type="submit" onclick={create_account}
                    class="w-full text-gray-100 bg-red-700 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Create an account</button>
